...
class BaumannCurRel(db.Model):
    ...
    baumann_output_id = db.Column(db.Integer, db.ForeignKey('baumann_output.id', ondelete='CASCADE'), nullable=False)
...
class BaumannOutput(db.Model):
    ...
    skintype = db.Column(db.String(45), nullable=False)
    dry_oily = db.Column(db.String(45), nullable=False)
    sen_res = db.Column(db.String(45), nullable=False)
    pig_nonpig = db.Column(db.String(45), nullable=False)
    wrinkle_tight = db.Column(db.String(45), nullable=False)
...
class ImgCurRel(db.Model):
    __tablename__ = 'img_cur_rel'
    id = db.Column(db.Integer, primary_key=True, nullable=False)
    img_output_id = db.Column(db.Integer,  db.ForeignKey('img_output.id', ondelete='CASCADE'), nullable=False)
...
class ImgOutput(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, nullable=False)
    img_desc_id = db.Column(db.Integer,  db.ForeignKey('img_desc.id', ondelete='CASCADE'), nullable=False)
    uid = db.Column(db.Integer,  db.ForeignKey('user_info.id', ondelete='CASCADE'), nullable=False)
    moisture = db.Column(db.String(45), nullable=False)
    pore = db.Column(db.String(45), nullable=False)
    oily = db.Column(db.String(45), nullable=False)
    pigment = db.Column(db.String(45), nullable=False)
    wrinkle = db.Column(db.String(45), nullable=False)
    total_score = db.Column(db.Integer, nullable=False)
    ...
    wrinkle_score = db.Column(db.Integer, nullable=False)
    created_date = db.Column(db.DateTime, nullable=False, default=datetime.now) 
...
class Survey(db.Model):
    ...
    student_env = db.Column(db.String(45), nullable=True)
    work_env = db.Column(db.String(45), nullable=True)
    freel_env = db.Column(db.String(45), nullable=True)
...
class SurveyCurRel(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True, nullable=False)
    answer_code = db.Column(db.String(45), nullable=False)
    cur_kw1_code = db.Column(db.Integer,  db.ForeignKey('cur_kw1.code', ondelete='CASCADE'), nullable=False)
    cur_kw2_code = db.Column(db.Integer,  db.ForeignKey('cur_kw2.code', ondelete='CASCADE'), nullable=False)
...
class TotalScoreOutput(db.Model):
    ...
    wrinkle = db.Column(db.Integer, nullable=False)
    created_date = db.Column(db.DateTime, nullable=False, default=datetime.now)
