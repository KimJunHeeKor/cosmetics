...
Revision ID: e80ebb3af81d
Revises: 8c93cc0db145
Create Date: 2021-09-02 10:35:20.826879
...
revision = 'e80ebb3af81d'
down_revision = '8c93cc0db145'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('sensitivie', sa.Integer(), nullable=False),
    sa.Column('created_date', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['s_id'], ['submit.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
