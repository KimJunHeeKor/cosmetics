...
Revision ID: b12cf445c805
Revises: 1787520d0812
Create Date: 2021-08-30 15:08:22.800492
...
revision = 'b12cf445c805'
down_revision = '1787520d0812'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('created_date', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['s_id'], ['submit.id'], ondelete='CASECADE'),
    sa.PrimaryKeyConstraint('id')
    )
