...
Revision ID: 8eaed7721c69
Revises: 7092f276b8b4
Create Date: 2021-08-23 17:09:32.605328
...
revision = '8eaed7721c69'
down_revision = '7092f276b8b4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('price', sa.String(length=45), nullable=False),
    sa.Column('ingredients', sa.String(length=45), nullable=False),
    sa.Column('type', sa.String(length=45), nullable=False),
    sa.Column('skintype', sa.String(length=45), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('answer_code', sa.String(length=45), nullable=False),
    ...
    sa.Column('skintype', sa.String(length=45), nullable=False),
    sa.Column('dry_oily', sa.String(length=45), nullable=False),
    sa.Column('sen_res', sa.String(length=45), nullable=False),
    sa.Column('pig_nonpig', sa.String(length=45), nullable=False),
    sa.Column('wrinkle_tight', sa.String(length=45), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('img_desc_id', sa.Integer(), nullable=False),
    sa.Column('uid', sa.Integer(), nullable=False),
    sa.Column('moisture', sa.String(length=45), nullable=False),
    sa.Column('pore', sa.String(length=45), nullable=False),
    sa.Column('oily', sa.String(length=45), nullable=False),
    sa.Column('pigment', sa.String(length=45), nullable=False),
    sa.Column('wrinkle', sa.String(length=45), nullable=False),
    sa.Column('total_score', sa.Integer(), nullable=False),
    ...
    sa.Column('wrinkle_score', sa.Integer(), nullable=False),
    sa.Column('created_date', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['img_desc_id'], ['img_desc.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['uid'], ['user_info.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('baumann_cur_rel',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('baumann_output_id', sa.Integer(), nullable=False),
    sa.Column('cur_kw1_code', sa.Integer(), nullable=True),
    sa.Column('cur_kw2_code', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['baumann_output_id'], ['baumann_output.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['cur_kw1_code'], ['cur_kw1.code'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['cur_kw2_code'], ['cur_kw2.code'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('img_cur_rel',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('img_output_id', sa.Integer(), nullable=False),
    sa.Column('cur_kw1_code', sa.Integer(), nullable=False),
    sa.Column('cur_kw2_code', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['cur_kw1_code'], ['cur_kw1.code'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['cur_kw2_code'], ['cur_kw2.code'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['img_output_id'], ['img_output.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('wrinkle', sa.Integer(), nullable=False),
    sa.Column('created_date', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['baumann_output_id'], ['baumann_output.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['img_output_id'], ['img_output.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['uid'], ['user_info.id'], ondelete='CASCADE'),
...
def downgrade():
    ...
    op.drop_table('img_cur_rel')
    op.drop_table('baumann_cur_rel')
