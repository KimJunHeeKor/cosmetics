...
Revision ID: 68340657c9f3
Revises: 85deaab7f082
Create Date: 2021-09-24 12:03:54.187012
...
revision = '68340657c9f3'
down_revision = '85deaab7f082'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('pigment_ori', sa.Integer(), nullable=False),
    sa.Column('pore_ori', sa.Integer(), nullable=False),
    sa.Column('oily_ori', sa.Integer(), nullable=False),
    sa.Column('created_date', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['s_id'], ['submit.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('total_lvl', sa.String(length=10), nullable=False),
    sa.Column('moisture_lvl', sa.String(length=10), nullable=False),
    sa.Column('pore_lvl', sa.String(length=10), nullable=False),
    sa.Column('oily_lvl', sa.String(length=10), nullable=False),
    sa.Column('pigment_lvl', sa.String(length=10), nullable=False),
    sa.Column('sensitivity_lvl', sa.String(length=10), nullable=False),
    sa.Column('created_date', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['s_id'], ['submit.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
